...
public class AccountServiceImpl implements AccountService {
  ...
  @Cacheable(value = "accountEmails", key = "#accountId")
  ...
  public AccountSettings updateAccountSettings(AccountSettingsInputDto accountSettingsInputDto) {
    ...
    accountSettings.setDefaultNotificationBreakReminderTime(
        accountSettingsInputDto.getDefaultNotificationBreakReminderTime());
    ...
    accountSettings.setDefaultShoppingListCategoryColour(
        accountSettingsInputDto.getDefaultShoppingListCategoryColour());
  ...
  public AccountSettings updateAccountSettingsByFields(AccountSettingsInputDto accountSettingsInputDto) {
    ...
    if (Objects.nonNull(accountSettingsInputDto.getDefaultPomodoroLongBreakInterval())) {
      accountSettings.setDefaultPomodoroLongBreakInterval(
          accountSettingsInputDto.getDefaultPomodoroLongBreakInterval());
    }
    if (Objects.nonNull(accountSettingsInputDto.getDefaultPomodoroLongBreakDuration())) {
      accountSettings.setDefaultPomodoroLongBreakDuration(
          accountSettingsInputDto.getDefaultPomodoroLongBreakDuration());
    }
