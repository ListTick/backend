...
public class CategoryServiceImpl implements CategoryService {
    ...
    public List<CategoryDTO> getAllByAccountId(UUID accountId) {
...
//                .toList();
    ...
    public CategoryDTO create(UUID accountId, CategoryInputDTO categoryInputDTO) {
        var account = accountRepository.findById(accountId)
                .orElseThrow(() -> new AccountException(accountId.toString()));
